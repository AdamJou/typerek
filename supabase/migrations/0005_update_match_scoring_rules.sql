...
set
  result_points = 2,
  exact_score_bonus = 5,
  first_scorer_points = 1
where active = true;

alter table public.scoring_rules
  alter column result_points set default 2,
  alter column exact_score_bonus set default 5,
  alter column first_scorer_points set default 1;
